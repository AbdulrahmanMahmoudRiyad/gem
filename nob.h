...
// It pops a command line like shift command from bash.
...
// Append a single NULL character at the end of a string builder. To be used as NULL-terminated C string
...
// Render a string representation of a command into a string builder.
...
int nob_needs_rebuild(const char *output_path, const char **input_paths, size_t input_paths_count)
{
    ...
    if (output_path_fd == INVALID_HANDLE_VALUE) {
        // if output does not exist it should be rebuilt
    ...
    for (size_t i = 0; i < input_paths_count; ++i) {
        ...
        // if a single input_path is fresher than output_path that's 100% rebuild
